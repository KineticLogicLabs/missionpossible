            ...
            <div className="flex flex-col flex-grow px-2 pb-2">
              ...
              <div className="space-y-3">
                <button 
                  ...
                  className="w-full py-4 bg-primary text-white font-sans text-xs font-bold tracking-wider uppercase rounded-sm flex items-center justify-center gap-2 hover:bg-blue-600 transition-all active:scale-95 shadow-sm border border-primary"
                >
