    ...
    <div className="px-6 pb-32 max-w-7xl mx-auto overflow-hidden">
      ...
      <section className="flex flex-col lg:flex-row items-center gap-16 mb-32 lg:py-20">
        <div className="flex-1 space-y-8 reveal">
          <div>
            <span className="inline-block py-1.5 px-4 bg-primary/10 border border-primary/20 text-primary text-[10px] font-bold uppercase tracking-widest rounded-full mb-8">
              Engineering Assist
            </span>
      ...
      <section className="mb-32 py-16 border-y border-black/5 dark:border-white/5 reveal">
        <div className="max-w-3xl mx-auto text-center space-y-10">
          <div className="inline-flex items-center gap-3">
            ...
            <h2 className="text-xs font-bold uppercase tracking-[0.4em] text-primary">Crafted with Intent</h2>
            <div className="w-10 h-[1px] bg-primary/40"></div>
          </div>
